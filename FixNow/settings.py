...
SECRET_KEY = 'django-insecure-y(77zceu1u=o_k3bh!r(!36bh9g+kf4b+i=6moy@0-^hp7f&vx'
...
# Optional: for collecting all static files in one folder (useful in production)
